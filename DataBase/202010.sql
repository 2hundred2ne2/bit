...
select * -- hiredate,substr(hiredate,4,2)
from emp
...
select  round(sysdate - to_date('2020-01-01','YYYY-MM-DD'),0) 
from dual;

select  to_date('2020-01-01','YYY-MM-DD')
from dual;
...
​
SELECT JOB ,MAX(SAL),MIN(SAL),ROUND(AVG(SAL),0) 
FROM EMP
GROUP BY  JOB ;
​
