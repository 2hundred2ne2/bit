   ...
   <div class="paging">
       ...
       function searchMyMsg() {
        ...
        function upMsg(){
			...
			/*게스트북 리스트 출력*/
			$.ajax({
				url : 'http://localhost:8080/gb/rest/guestbook?p='+p,
				type : 'GET',
				success : function(data){
					...
					$.each(list, function(index, item){
						...
						html +='  <span class="gUpDate">'+item.gdate+'</span>';
         ...
         /*  방명록 데이터 등록 */
			...
			$('#sbmtbtn').click(function() {
			       ...
			       $.ajax({
		               url : 'http://localhost:8080/gb/rest/guestbook/upload',
		               type : 'post',
		               data : form_data,
		               dataType : 'json',
		               async : true,
            ...
            function edit_btn(gidx) {
            	...
            	if (confirm('방명록을 수정하시겠습니까? ')) {
        			...
        			$('#edit').click(function() {
        				...
        				$.ajax({
        					url : 'http://localhost:8080/gb/rest/guestbook/edit',
        					type : 'post',
        					data : form_data,
        					dataType : 'json',
        					async : true,
           ...
           /* 방명록 삭제  */
            function del_btn(gidx) {
            	...
            	if (confirm('방명록을 삭제하시겠습니까?')) {
    				...
    				$.ajax({
    					url : 'http://localhost:8080/gb/rest/guestbook/delete?gidx=' + gidx,
    					type : 'post',
    					success : function(data){
    						console.log("ajax data",data);
