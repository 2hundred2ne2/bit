...
public class MemberListView {
	private int pageNumber;// 현재페이지번호
	private int totalMemberCount;// 한페이지에 노출할 게시물의 개수
	private int cntPerPage;// 한페이지에 노출할 게시물의 개수
	private List<Member> memberList; // 페이지에 노출할 회원의 정보를 담는 리스트
	private int startRow;
	private int endRow;
	private int totalPageCount;//전체페이지의 개수
	...
	private void calTotalPageCount() {
		this.totalPageCount=totalMemberCount/cntPerPage;
